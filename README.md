...
I have updated the ["AC wiring diagram"](Voron_2.4_Electronics_Case_Wiring_Diagram_AC_wiring.pdf) to reflect the changes to the BIG RED mushroom Emergency Button.  I also modified the [Skirt-Microfit-Inserts Mod from Ett's ERCF project](https://github.com/GadgetAngel/Voron2.4_My_Build_Log/blob/main/The_.STL_Files/GA_modded_STLs/Skirt/Front/A/%5Ba%5D_Button_mount%20Z-tensioner_Mod_Front_OR_Rear_Hour_Counter_Skirt_A_300_x2.stl) so that I would have a place to mount QUEEN's Printer Reset
