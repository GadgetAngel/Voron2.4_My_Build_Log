...
I have updated the ["AC wiring diagram"](images\Voron_2.4_Electronics_Case_Wiring_Diagram_AC_wiring.pdfVoron_2.4_Electronics_Case_Wiring_Diagram_AC_wiring.pdf) to reflect the changes to the BIG RED mushroom Emergency Button.  
